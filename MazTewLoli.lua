...
local Window = Fluent:CreateWindow({
    Title = "MazTew Loli Hub | Blox Fruits [Free]",
    SubTitle = "By Maz",
    TabWidth = 160,
...
_G.FastAttack = true    
    ...
    local ToggleCastleRaid = Tabs.Main:AddToggle("ToggleCastleRaid", {Title = "Farm Castle Raid", Default = false })
...
if Third_Sea then
local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Farm Bones", Default = false })
...
spawn(function()
    ...
    local ToggleSpawnCake = Tabs.Main:AddToggle("ToggleSpawnCake", {Title = "Auto Spawn Katakuri", Default = true })
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    spawn(function()
      ...
      if Third_Sea then
      local RoughSea = Tabs.Even:AddSection("🦊 Kitsune 🦊")


      local ToggleEspKitsune = Tabs.Even:AddToggle("ToggleEspKitsune", {Title = "Esp Kitsune Island", Default = false })
      ...
      local ToggleTPKitsune = Tabs.Even:AddToggle("ToggleTPKitsune", {Title = "Tween To Kitsune Island", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Even:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Ambers", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Even:AddToggle("ToggleSailBoat", {Title = "Auto Buy Ship", Default = false })
    ...
    spawn(function()
      ...
      local RoughSea = Tabs.Even:AddSection("🦈 Sea Even 🦈")

    local ToggleTerrorshark = Tabs.Even:AddToggle("ToggleTerrorshark", {Title = " Kill Terrorshark", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Even:AddToggle("TogglePiranha", {Title = " Kill Piranha", Default = false })
     ...
     local ToggleShark = Tabs.Even:AddToggle("ToggleShark", {Title = " Kill Shark", Default = false })
    ...
    local ToggleFishCrew = Tabs.Even:AddToggle("ToggleFishCrew", {Title = " Kill Fish Crew", Default = false })
    ...
    local ToggleShip = Tabs.Even:AddToggle("ToggleShip", {Title = "Kill Ship", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Even:AddToggle("ToggleGhostShip", {Title = "Kill Ghost Ship", Default = false })
...
local ToggleSeaBeAst = Tabs.Even:AddToggle("ToggleSeaBeAst", {Title = "Kill Sea Beast", Default = false })
...
local ToggleAutoW = Tabs.Even:AddToggle("ToggleAutoW", {Title = "Auto Press W", Default = false })
ToggleAutoW:OnChanged(function(Value)
 ...
 spawn(function()
    while wait() do
      ...
      local RoughSea = Tabs.Even:AddSection("🏝 Mirage Island 🏝️️")

local ToggleTweenMirageIsland = Tabs.Even:AddToggle("ToggleTweenMirageIsland", {Title = "Tween To Mirage Island", Default = false })
...
local ToggleTweenGear = Tabs.Even:AddToggle("ToggleTweenGear", {Title = "Tween To Gear", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Even:AddToggle("Togglelockmoon", {Title = "Lock Moon and Use Race Skill", Default = false })
...
local ToggleMirage = Tabs.Even:AddToggle("ToggleMirage", {Title = "Auto Mirage Island", Default = false })
